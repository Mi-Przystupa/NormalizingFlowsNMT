...
inputs="--use_bpe -src_bpe ./bpe_models/$5.model  -trg_bpe ./bpe_models/$6.model -word_dropout 0.0 -opt tuning"
echo "Evaluating models for for $1 -> $2 translation with $3 number of flows"
