...
train_config="--epochs 8 --batch_size 64 --print_every 1000 --dropout .50 -opt validate" #vnmt technically did not use dropout, but it does help with generalization 
