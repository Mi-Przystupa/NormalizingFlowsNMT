import sacrebleu
#just wrappers around better implementations
import os
import re
import subprocess
import tempfile
...
def rawBLEU(hypotheses, references, smooth_flr=0.01):
    bleu = sacrebleu.raw_corpus_bleu(hypotheses, [references], smooth_flr)
    return bleu.score
...
# I stole this from here: https://pytorchnlp.readthedocs.io/en/latest/_modules/torchnlp/metrics/bleu.html
